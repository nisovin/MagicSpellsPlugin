...
public class TreeGrower
{
        ...
        for(; j2 <= i2; j2++)
        {
            ...
            for(int l2 = -i2; l2 <= i2;)
            {
                ...
                } else
                {
                    ...
                    int i3 = etc.getServer().getBlockIdAt(ai1[0], ai1[1], ai1[2]);
                    if(i3 != 0 && i3 != 18)
                    {
                        l2++;
                    } else
                    {
                    	etc.getServer().setBlockAt(l1, ai1[0], ai1[1], ai1[2]);
    ...
    void a(int ai[], int ai1[], int i1)
    {
        ...
        {
            ai3[j1] = hgb((double)(ai[j1] + k1) + 0.5D);
            ai3[byte1] = hgb((double)ai[byte1] + (double)k1 * d1 + 0.5D);
            ai3[byte2] = hgb((double)ai[byte2] + (double)k1 * d2 + 0.5D);
            etc.getServer().setBlockAt(i1, ai3[0], ai3[1], ai3[2]);
    ...
    int a(int ai[], int ai1[])
    {
        ...
        do
        {
            ...
            int l1 = etc.getServer().getBlockIdAt(ai3[0], ai3[1], ai3[2]);
            if(l1 != 0 && l1 != 18)
                break;
            j1 += byte3;
        } while(true);
    ...
    boolean e()
    {
        ...
        int i1 = etc.getServer().getBlockIdAt(d[0], d[1] - 1, d[2]);
        if(i1 != 2 && i1 != 3)
            return false;
        int j1 = a(ai, ai1);
        if(j1 == -1)
    ...
    public boolean grow(Random random, int i1, int j1, int k1)
    {
        //c = ep1;
  ...
  public static int hgb(double paramDouble)
  {
